...
public class Cocos2dxVideoView extends SurfaceView {
    ...
    private final String TAG = "Cocos2dxVideoView";
    ...
    private final int mSeekWhenPrepared = 0;
    ...
    public void stop() {
        if (!(mCurrentState == State.IDLE || mCurrentState == State.INITIALIZED || mCurrentState == State.ERROR
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
                    messageId = r.getIdentifier("VideoView_error_text_invalid_progressive_playback", "string",
                            "android");
                } else {
