...
internal class InsecureSHA1PRNGKeyDerivator private constructor() {
    ...
    @Transient
    private val seed: IntArray = IntArray(HASH_OFFSET + EXTRAFRAME_OFFSET)
    ...
    protected fun nextBytes(bytes: ByteArray?) {
        ...
        var nextByteToReturn = 0 // index of ready bytes in "bytes" array
    ...
    companion object {
        ...
        private fun updateHash(
            ...
            // writing full words
            val maxWord: Int = toByte - i + 1 shr 2 // # of remaining full words, may be "0"
